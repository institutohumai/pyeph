QUARTER_OR_WAVE_OPTION = """Para bases de datos hasta 2003, el tipo de frecuencia (freq) debe ser 'onda'
Para bases de datos desde 2004, el tipo de frecuencia (freq) debe ser 'trimestre'"""

INDEC_2007_3 = """INDEC advierte: La informacion correspondiente al tercer trimestre 
